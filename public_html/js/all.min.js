...
function burgerBtnToggler(){let t=$(".header-menu-burger");t.on("click",function(){$(this).find(".header-menu-btn").toggleClass("active"),$(".header-menu-mobile").toggleClass("active")})}function productSizeSelectric(){$("select.product-size").selectric().on("change",function(){let e=$(this).parents(".product-card").find(".before-price").toArray(),i=$(this).parents(".product-card").find(".curent-price").toArray(),a=$(this).parents(".product-card").find(".selectric-items>.selectric-scroll>ul>li.selected").data("index");e.forEach(t=>{$(t).data("index")==a&&($(e).not(t).addClass("hidden"),$(t).removeClass("hidden"))}),i.forEach(t=>{$(t).data("index")==a&&($(i).not(t).addClass("hidden"),$(t).removeClass("hidden"))})})}function swiperSlider(){new Swiper(".slider-container",{slidesPerView:"auto",speed:400,spaceBetween:8,watchSlidesVisibility:!0,breakpoints:{320:{spaceBetween:8},641:{spaceBetween:16},1025:{spaceBetween:45}}})}function timer(){let n=$(".timer-hours"),o=$(".timer-minuts"),r=$(".timer-seconds"),s=new Date;function d(t){return("0"+parseInt(t)).substr(-2)}let t=new Date;13<=t.getHours()?s.setHours(23,60,60):s.setHours(12,60,60),function t(){var e=new Date;e>s&&s.setHours(s.getHours()+12);var i=(s-e)/1e3,a=d(i/60/60%60),e=d(i/60%60),i=d(i%60);n.text(a),o.text(e),r.text(i),setTimeout(t,1e3)}()}function animateScroll(){function t(){var t=$(this).attr("href");$("html, body").animate({scrollTop:$(t).offset().top},{duration:450,easing:"linear"})}$(".header-menu-item>a").on("click",t),$(".header-menu-mobile-item>a").on("click",t),$(".footer-menu-list>li>a").on("click",t),$(".baner-block-description>a").on("click",t)}function maskedPhone(){let t=$(".footer-form>input[name=phone]"),e=$("#form_buy form input[name=buy_phone]");t.mask("+38 (099) 999 99 99"),e.mask("+38 (099) 999 99 99")}function footerFormValidate(){let t=$(".footer-form");t.validate({rules:{phone:{required:!0,minlength:19}},messages:{phone:{required:"Введите номер телефона",minlength:"Номер должен быть в формате +38 (099) 999 99 99"}},submitHandler:function(){return $.ajax({type:"POST",url:"/mailFooter.php",data:t.serialize(),success:function(){$.fancybox.open({src:"#popup_thanks",opts:{smallBtn:!1,baseClass:"custom-fancybox",touch:!1}})}}),!1}})}function informFancyBox(){$(".fancy-popup").fancybox({smallBtn:!1,baseClass:"custom-fancybox",touch:!1})}function customScroll(){$(".inform-content").mCustomScrollbar()}function buyProduct(){let t=$(".product-card");t.on("click",".btn-buy",function(){$.fancybox.open({src:"#form_buy",opts:{smallBtn:!1,baseClass:"custom-fancybox",touch:!1}});let i=$(this).parents(".product-card").find(".product-name").text(),a=$(this).parents(".product-card").find(".selectric-items .selectric-scroll ul>li.selected").text(),n=$("#form_buy form");n.validate({rules:{buy_phone:{required:!0,minlength:19}},messages:{buy_phone:{required:"Введите номер телефона",minlength:"Номер должен быть в формате +38 (099) 999 99 99"}},submitHandler:function(t){var e=n.serialize()+"&productName="+i+"&productSize="+a;$.ajax({type:"POST",url:"/mail.php",data:e,success:function(){window.location="/thanks"}})}})})}function wowAnimate(){let t=new WOW({offset:200,visibility:"hidden",callback:function(t){$(t).hasClass("animate")&&$(t).addClass("animate-active")}});t.init()}function setMainMenuAnimateDelay(){var t=$(".product-card");if(0!=t.length){if(990<$(window).width())for(i=0;i<t.length;i+=3)$(t[i]).attr("data-wow-delay","0s"),$(t[i+1]).attr("data-wow-delay","0.1s"),$(t[i+2]).attr("data-wow-delay","0.2s");if($(window).width()<=990&&680<$(window).width())for(i=0;i<t.length;i+=2)$(t[i]).attr("data-wow-delay","0s"),$(t[i+1]).attr("data-wow-delay","0.1s");else if($(window).width()<=680)for(i=0;i<t.length;i++)$(t[i]).attr("data-wow-delay","0s")}var e=$(".advantages-items-item");if(0!=e.length){if(990<$(window).width())for(i=0;i<e.length;i+=3)$(e[i]).attr("data-wow-delay","0s"),$(e[i+1]).attr("data-wow-delay","0.1s"),$(e[i+2]).attr("data-wow-delay","0.2s");if($(window).width()<=990&&640<$(window).width())for(i=0;i<e.length;i+=2)$(e[i]).attr("data-wow-delay","0s"),$(e[i+1]).attr("data-wow-delay","0.1s");else if($(window).width()<=640)for(i=0;i<e.length;i++)$(e[i]).attr("data-wow-delay","0s")}var a=$(".feedback");if(0!=a.length){if(990<$(window).width())for(i=0;i<a.length;i+=4)$(a[i]).attr("data-wow-delay","0s"),$(a[i+1]).attr("data-wow-delay","0.1s"),$(a[i+2]).attr("data-wow-delay","0.2s"),$(a[i+3]).attr("data-wow-delay","0.3s");if($(window).width()<=990)for(i=0;i<a.length;i+=2)$(a[i]).attr("data-wow-delay","0s"),$(a[i+1]).attr("data-wow-delay","0.1s")}}$(document).ready(function(){burgerBtnToggler(),productSizeSelectric(),swiperSlider(),timer(),footerFormValidate(),animateScroll(),maskedPhone(),informFancyBox(),customScroll(),buyProduct(),wowAnimate(),setMainMenuAnimateDelay()});